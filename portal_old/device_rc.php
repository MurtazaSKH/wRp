							 ...
							 if($dsgID == $adminDsg[$j])
								 {
									echo "<div class='actionbar'>
										...
										<a href=\"locatedevice.php?deviceid=" . $row['DeviceID'] . "\" class=\"btn btn-info\" style=\"margin:0px 4px; background-color:#DE5B5B;\"><i class=\"fa fa-location-arrow\"></i><span> Find Device</span></a>
