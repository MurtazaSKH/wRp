    ...
    <div id="check1">
      <div class="check1-inner">
        <div class="navbar">
          ...
          <div class="check2">
            <ul class="check2">
              <li class="first leaf" id="firstLeaf" style="margin-left: 31px;"><a title="" class="hvr-bounce-to-top" id="homebutton"  href="index.php"><i class="service-icon fa fa-home" style="font-size:20px; "></i> </a></li>
