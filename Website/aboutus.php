...
<html>
   ...
   <body >
      ...
      <div class="pt100 pb70 pb85-xs" style="background: linear-gradient( rgba(0, 0, 0,1), rgba(0, 0, 0, 0.67) ),url('./rsrc/images/about_bg3.jpg'); background-position: center center;  background-repeat: no-repeat;    background-size: cover; background-attachment:fixed; border-top: 2px solid yellow; border-bottom: 2px solid green; ">
         <div class="container">
            <div class="row">
                  ...
                  <ul id="pe-thumbs" class="pe-thumbs">
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/1.jpg" style=" transform: scale(1);  opacity: 0.7;">
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/2.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/3.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           ...
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Tariq Mehmood | Artist Lead</h3>
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/7.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Hammad Ahmed Khan | QA Engineer</h3>
                     ...
                     <!-- <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           ...
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Usman Mehmood | Lead Developer</h3>
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/12.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Ejaz Kiyani</h3>
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/13.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Arsalan Kamal</h3>
                     ...
                     <!-- <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/15.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/16.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Majid Azim</h3>
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/18.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Kamran Malik</h3>
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/21.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/23.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/24.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Shan Hassan</h3>
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/25.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Khizer Javaid</h3>
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/26.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Saadia Bashir</h3>
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/29.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Ghaniah Ejaz | 2D Artist</h3>
                              <p>I have a background in Computer Science, Deep thinking and having coffee in winter mornings. Love marketing, branding and Psychiatry.</p>
                           </div>
                        </a>
                     </li>
                     <li style="z-index: 1;">
...
and kill them. Happy Killing :P</p>
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/37.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Khaula Khurshid | QA Lead</h3>
                              <p> I did my Bachelors in Mechatronics Engineering from CE&ME , NUST. I love cats, playing and listening to music literally all the time. I joined weRplay because whats better in this world than being paid for pointing out bugs & having fun? :p Rest, all that matters is my future and my passion for games & music.</p>
                           </div>
                        </a>
                     </li>
                     <!-- <li style="z-index: 1;">
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           ...
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Asad Pervaiz | QA Lead</h3>
                              <p>A graduate from COMSATS, Islamabad.I love games,photography,filmmaking and music. I have recently joined we.R.play and absolutely loving this place.</p>
                           </div>
                        </a>
                     </li>
                     <li style="z-index: 1;">
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/44.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Shaloof Khalid | QA Lead</h3>
                              <p>I have done BS(CS) from FAST. I worked as a Project Quality Engineer in a software house for around a year just after my graduation. QA is my passion, I enjoy QA, it’s more fun to me than work :D .Now I am working in weRplay to gather more QA experience and improve my skill set, playing more n more games and finding bugs :D. Besides this I love travelling and food:D</p>
                           </div>
                        </a>
                     </li>
                     <li style="z-index: 1;">
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/47.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Ayesha Beg | QA Analyst</h3>
                              <p> I have a business background but now a days trying to settle in the IT world and all because of we.R.play the experience is going great . Apart from settling in and learning new things I love to travel, listen to music but sitting on the couch and watching TV is the all time favorite.</p>
                           </div>
                        </a>
                     </li>
                     <li style="z-index: 1;">
...
`                             (P.S just done tell noor that she can’t do something )  :P</p>
                     ...
                     <!-- more starting from here -->
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/51.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Waqas Mirza | HR Manager</h3>
                              <p>I have done BBA (H) and MBA from Iqra University Islamabad. I worked at PSEB for around 1.5 yrs. After that I joined OvexTech in HR department, where I worked for 1.9 months and now I am here at we.R.play :).</p>
                           </div>
                        </a>
                     </li>
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           <img src="./rsrc/images/thumbs/52.jpg" style="transform: scale(1); opacity: 0.7;">
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Samad Shahid | Developer</h3>
                              <p>I, am what you call a computer freak. After getting educated in the science of the computers in my Bachelors, Inter and Matriculation, I  fell in love with the beauty of Technology and now my days AND nights are spent with computers, my one true love.</p>
                           </div>
                        </a>
                     </li>
                     <!-- <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           ...
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Imran Khan | Content Designer</h3>
                              <p>That lives encompassed in a mortal frame, That lives encompassed in a mortal frame, That lives encompassed in a mortal frame.</p>
                           </div>
                        </a>
                     </li> -->
                     ...
                     <li style="z-index: 1;">
                        <a onclick="return false" href="#">
                           ...
                           <div class="pe-description" style="height: auto; top: -15px; left: 115px; display: none;">
                              <h3>Shahid Ammer Yar | Developer</h3>
                              <p>I am Computer Science graduate from IBA. Love playing football, and other indoor games. Besides this I love to travel and its my dream to live in as many places as I can.</p>
                           </div>
                        </a>
                     </li>
                     <!-- <li style="z-index: 1;">
