...
<html>
    ...
    <body>
    	<?php
			...
			{
			//get the EID 
			$query = "SELECT EID FROM employeeinfo WHERE LOWER(Email) = LOWER('$EMAIL')";
			...
			/*elseif ($PASS== "" || $PASS != $password && $procedure != 'gplus' )//password check
			{
				echo '<script type="text/javascript">'
			...
			else//get required info put it in session and redirect to account home
			{
				...
				{
					$_SESSION['AvatarPath'] = "img/test_avatar.png";
				}//end of if
				else
				{
