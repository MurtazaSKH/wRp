$(function() {
    ...
    // for image <div class="media-left"><img src="assets/images/profil_page/friend8.jpg" class="dis-block img-circle"></div>
    notifContent = '<div class="alert alert-dark media fade in bd-0" id="message-alert"><div class="media-body width-100p"><h4 class="alert-title f-14">New message received</h4><p class="f-12 alert-message pull-left">Welcome Back to Device Portal!</p><p class="pull-right"><a href="#" class="f-12" >&nbsp Dismiss</a></p></div></div>';
    setTimeout(function() {
