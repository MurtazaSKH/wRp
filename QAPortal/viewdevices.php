                    ...
                    <thead>
                      <tr>
                        ...
                        <?php
                          ...
                          {
                            echo "<th class='' style='display:none;';'>Edit</th>";
                          }
                      ...
                      <?php 
                          ...
                          if(mysqli_num_rows($result) > 0)
                          {
                              ...
                              { 
                                  ...
                                  {
                                    echo '<tr class="" style="color:black;"><td style="background-color:#ABB1BB;">'.$count++.'</td>';
                            ...
                            echo '<td class="center"style="display:none;">'.$row['OSType'].'</td>';
                                  ...
                                  {
                                    echo '<tr class="" style="color:white;"><td style="background-color:#525761;">'.$count++.'</td>';
