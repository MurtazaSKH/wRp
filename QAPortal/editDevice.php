...
<html lang="en">
  <head>
    ...
    <title> Portal | Admin - Edit Device</title>
            ...
            <div class="col-md-6">
              <div class="panel panel-default no-bd">
                <div class="panel-header bg-dark" >
                  <h2 class="panel-title" style="padding: 6px 15px 6px 18px; font-size:25px;" ><strong>Edit Device</strong></h2>
                </div>
                <div class="panel-body bg-white">
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <form role="form" method="post"  class="form-validation" id="formavatar" <?php echo 'action="javascript:updateDevice('.$row['DeviceID'].')"' ?>  name="formavatar">
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group">
                              <label class="control-label">Device name</label>
                              <div class="append-icon">
                                <input type="text" name="devicename" id="devicename" class="form-control" minlength="3"  required="" <?php echo 'value="'.$row['name'].'"'; ?> aria-required="true">
                          ...
                          <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <div class="append-icon">
                                <input type="text" name="deviceos" id="deviceos" class="form-control" minlength="1" required="" <?php echo 'value="'.$row['OSType'].'"'; ?> aria-required="true">
                          ...
                          <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <div class="append-icon">
                                <input type="text" name="osversion" id="osversion" class="form-control"  <?php echo 'value="'.$row['OSVersion'].'"'; ?> required="" aria-required="true" >
                          ...
                          <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <div class="append-icon">
                                <input type="text" name="resolution" id="resolution" class="form-control"  required="" <?php echo 'value="'.$row['Resolution'].'"'; ?> aria-required="true">
                          ...
                          <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              ?>
                              <div class="append-icon">
                                <input type="text" name="vendor" id="vendor" class="form-control" style="height:35px;"  <?php echo 'value="'.$row['Vendor'].'"'; ?> minlength="3" required="" aria-required="true" >
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <div class="append-icon">
                                <input type="text" name="priority" id="priority" class="form-control"  <?php echo 'value="'.$row['Priority'].'"'; ?> required="" aria-required="true" >
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <div class="append-icon">
                                <input type="text" name="imei" id="imei" class="form-control"  <?php echo 'value="'.$row['IMEI'].'"'; ?> >
                                <div id="desig-error" class="form-error" style="display:none;">Required</div>
                                <i class="icon-envelope"></i>
                              </div>
                            </div>
                          ...
                          <div class="col-sm-12">
                            <div class="form-group">
                              <label class="control-label">Device State</label>
                              <div class="append-icon">
                              <?php // echo 'value="'.$row['DIDs'].'"'; ?>
                                <select name="active" id="active" class="form-control">
                                  <option value="1">Active</option>
                                  <option value="0">Phased Out</option>
                        ...
                        <div class="text-center  m-t-20">
                          ...
                          <button  class="btn btn-embossed btn-primary">Update Device</button>
                        </div>
                      </form>
                    </div>
                  </div>
