...
<html>
    <head>
        <!-- BEGIN META SECTION -->
        <meta charset="utf-8">
        <title> Portal | Register Company</title>
            ...
            <div class="col-md-6">
              <div class="panel panel-default no-bd">
                <div class="panel-header bg-dark" >
                  <h2 class="panel-title" style="padding: 6px 15px 6px 18px; font-size:25px;" ><strong>Register</strong> your company.</h2>
                </div>
                <div class="panel-body bg-white">
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <form role="form" action="javascript:existingCompany();" class="form-validation">
                        <div class="row">
                          <div class="col-sm-6">
                          ...
                          <div style="display:none;">
                            <input type="text" name="todo" id="todo" value="register" class="form-control" style="height:35px;" placeholder="Select birthdate" minlength="3" required="" aria-required="true">
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label class="control-label">Password</label>
                              <div class="append-icon">
                                <input type="password" name="password" id="password" class="form-control" placeholder="Between 8 and 16 characters" minlength="8" maxlength="16" required="" aria-required="true">
                        ...
                        <div class="text-center  m-t-20">
                          <button type="submit" id="addadminbutton"  class="btn btn-embossed btn-primary">Register</button>
        ...
        <div class="footer" style="position:fixed; bottom:10px;">
            <div class="copyright">
              ...
              <p class="pull-right sm-pull-reset" style="position:fixed; bottom:10px; right:10px;">
                <span><!-- <a href="#" class="m-r-10">Sign Up</a> | --> <a href="#" class="m-l-10 m-r-10">Terms of use</a>
              </p>
            </div>
          </div>
