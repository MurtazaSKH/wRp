...
<html lang="en">
  <head>
    ...
    <title> Portal | Admin - Add Admin</title>
            ...
            <div class="col-md-12">
              <div class="panel panel-default no-bd">
                <div class="panel-header bg-dark" >
                  <h2 class="panel-title" style="padding: 6px 15px 6px 18px; font-size:25px;" ><strong>Add Company Admin</strong> <!-- and start managing your devices. --></h2>
                </div>
                <div class="panel-body bg-white">
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <form role="form" action"signingup.php" class="form-validation">
                        <div class="row">
                          <div class="col-sm-12">
                          ...
                          <div style="display:none;">
                            <input type="text" name="todo" id="todo" value="addnewAdmin" class="form-control" style="height:35px;" placeholder="Select birthdate" minlength="3" required="" aria-required="true">
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="text-center  m-t-20">
                          ...
                          <a href="#" id="addadminbutton" onclick="signup()" class="btn btn-embossed btn-primary">Add User</a>
